...
namespace qa_portal.Data
{
    public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                    res = ControllerConfigurationUtility.GetResourceStream(string.Format("qa_portal.controllers.{0}.xml", controller), string.Format("qa_portal.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
                t = typeof(qa_portal.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("qa_portal.Reports.{0}", name), string.Format("qa_portal.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = qa_portal.Data.Controller.CreateConfigurationInstance(t, controller);
