...
namespace qa_portal.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("qa_portal.Controllers.{0}.xml", DataController));
                if (res == null)
                    res = GetType().Assembly.GetManifestResourceStream(string.Format("qa_portal.{0}.xml", DataController));
                if (res != null)
