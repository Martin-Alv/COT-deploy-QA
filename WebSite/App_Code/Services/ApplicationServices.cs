...
using qa_portal.Data;
using qa_portal.Handlers;
using qa_portal.Services.Rest;
using qa_portal.Web;
...
namespace qa_portal.Services
{
        ...
        public static string ValidationKey
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(key) || key.Contains("AutoGenerate"))
                    key = "BC39298E99BC3192814D8011AB2C2FD64E20B240DC8241BF976DD135C3BC39FACB2B19154010901B0" +
                        "7AF0778A2B20A451F35A12F5F1A3900562CF671092CC953";
                return key;
            }
        }
    ...
    public partial class ApplicationServicesBase
    {
        ...
        {
            qa_portal.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                try
                {
                    ...
                    if (css == null)
                        css = ConfigurationManager.ConnectionStrings["qa_portal"];
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@qa_portal.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@qa_portal.com", "ASP.NET", "Code OnTime", true, out status);
