...
namespace qa_portal.Handlers
{
    public partial class Site : SiteBase
    {
    }

    public class SiteBase : qa_portal.Web.PageBase
    {
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            var themePath = Server.MapPath("~/App_Themes/qa_portal");
            if (Directory.Exists(themePath))
                foreach (var stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Azure.css")))
                    {
                        ...
                        {
                            Href = ("~/App_Themes/qa_portal/" + fileName)
                        };
